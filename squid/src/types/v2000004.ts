...
export const RcMigratorCall: sts.Type<RcMigratorCall> = sts.closedEnum(() => {
    return  {
        ...
        set_settings: sts.enumStruct({
            settings: sts.option(() => MigrationSettings),
        }),
...
export const MigrationSettings: sts.Type<MigrationSettings> = sts.struct(() => {
    return  {
        maxAccountsPerBlock: sts.option(() => sts.number()),
        maxItemsPerBlock: sts.option(() => sts.number()),
    }
})
 ...
 */
export interface RcMigratorCall_set_settings {
    __kind: 'set_settings'
    settings?: (MigrationSettings | undefined)
}
