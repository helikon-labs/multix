        ...
        <Center className={className}>
            ...
            <ul className="values">
                <li>
                    <h2>Open</h2>
                    <p>
                        Multix is open-source from the get-go. The back-end and front-end code can
                        be{' '}
                        <a
                ...
                <li>
                    ...
                    <p>
                        While Multix uses an open source indexer, the database is trust minimized
                        and only contains information coming from the chain. No user information is
                        stored and anyone can re-build this database at will.
                    </p>
                </li>
                <li>
                    <h2>Interoperable</h2>
                    Multix doesn&apos;t create a walled garden. You can create a multisig on-chain
                    anywhere, Multix will show it right away.
                </li>
                <li>
                    <h2>Privacy-preserving</h2>
                    <p>
                        We do not gather private information. Additional information such as names
                        is stored on your browser, and only visible to you.
                    </p>
                </li>
            </ul>
            <h1 className="title">
