...
export type MultisigByIdQuery = {
    ...
    accounts: Array<{
        ...
        signatories: Array<{
            __typename?: 'AccountMultisig';
            id: string;
            signatory: { __typename?: 'Account'; id: string; pubKey: string };
        }>;
    }>;
};
...
export const useMultisigByIdQuery = <TData = MultisigByIdQuery, TError = unknown>(
    ...
    options?: Omit<UseQueryOptions<MultisigByIdQuery, TError, TData>, 'queryKey'> & {
        queryKey?: UseQueryOptions<MultisigByIdQuery, TError, TData>['queryKey'];
    },
) => {
    return useQuery<MultisigByIdQuery, TError, TData>({
        queryKey: ['MultisigById', variables],
        queryFn: useFetchData<MultisigByIdQuery, MultisigByIdQueryVariables>(
...
>(
    ...
    options?: Omit<UseQueryOptions<MultisigsAndPureByAccountQuery, TError, TData>, 'queryKey'> & {
        queryKey?: UseQueryOptions<MultisigsAndPureByAccountQuery, TError, TData>['queryKey'];
    },
) => {
    return useQuery<MultisigsAndPureByAccountQuery, TError, TData>({
        queryKey:
            variables === undefined
                ? ['MultisigsAndPureByAccount']
                : ['MultisigsAndPureByAccount', variables],
        queryFn: useFetchData<
            MultisigsAndPureByAccountQuery,
            MultisigsAndPureByAccountQueryVariables
        >(MultisigsAndPureByAccountDocument).bind(null, variables),
        ...options,
    });
};
